...
import { TaskKanbanController } from '../controllers/KanbanController'
...
export class TaskRouter {
  public static getRouter(container: ContainerBuilder) {
    ...
    const kanbanController: TaskKanbanController = container.get('Task.controller.KanbanController')
    ...
    router.get('/tasks/kanban', (req: Request, res: Response) => kanbanController.run(req, res))
